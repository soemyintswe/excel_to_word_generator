...
class App:
    ...
    def move_double_click(self, event):
        ...
        # Determine logic where to send (Simple swapping)
    ...
    def generate_report(self):
        ...
        try:
            ...
            for batch_idx in range(math.ceil(len(df) / max_rows)):
                ...
                doc.save(f"output/Report_Page_{batch_idx + 1}.docx")
            messagebox.showinfo("Success", "ဖိုင်များ အောင်မြင်စွာ ထွက်ရှိပါပြီ။")
